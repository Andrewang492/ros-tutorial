...
int main(int argc, char **argv)
{
  ...
  ros::Publisher chatter_pub = n.advertise<std_msgs::String>("chatter", 1000);
		// note that it only advertises for std_msgs::String
...
/**
   ...
   *   a subscription into this application, and did not have ros::spinOnce() 
   *   here, your callbacks would never get called. So, add it for good measure.
   **/
    loop_rate.sleep();//sleep until 10hz rate is matched.
